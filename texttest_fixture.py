...
if __name__ == "__main__":
    ...
    items = [
             ...
             Concert(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=20),
             Concert(name="Backstage passes to a TAFKAL80ETC concert", sell_in=10, quality=49),
             Concert(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=49),
